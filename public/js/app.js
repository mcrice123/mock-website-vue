...
vue_dist_vue_min_js__WEBPACK_IMPORTED_MODULE_1___default.a.config.devtools = true; // Add Axios and Form globally

window.axios = axios;
window.Form = _form__WEBPACK_IMPORTED_MODULE_2__["default"];
new vue_dist_vue_min_js__WEBPACK_IMPORTED_MODULE_1___default.a({
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      this.form.post('/projects/store').then(function (response) {
        return _this.projects = response.projects;
      })["catch"](function () {});
    }
    /*    onSuccess(response) {
  ...
  mounted: function mounted() {
    ...
    axios.get('/projects/list').then(function (response) {
      return _this2.projects = response.data.projects;
    });
  }
});
/* Shared State 101 */
...
__webpack_require__(/*! /Users/maria/Desktop/Development/mock-website-vue/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/maria/Desktop/Development/mock-website-vue/resources/sass/app.scss */"./resources/sass/app.scss");
